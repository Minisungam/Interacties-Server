...
import { RetryAfterError } from "./RetryAfterError.mjs";
var ResponseBasedRateLimiter = /** @class */ (function () {
    ...
    Object.defineProperty(ResponseBasedRateLimiter.prototype, "lastKnownLimit", {
        get: function () {
            var _a, _b;
            return (_b = (_a = this._parameters) === null || _a === void 0 ? void 0 : _a.limit) !== null && _b !== void 0 ? _b : null;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(ResponseBasedRateLimiter.prototype, "lastKnownRemainingRequests", {
        get: function () {
            var _a, _b;
            return (_b = (_a = this._parameters) === null || _a === void 0 ? void 0 : _a.remaining) !== null && _b !== void 0 ? _b : null;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(ResponseBasedRateLimiter.prototype, "lastKnownResetDate", {
        get: function () {
            var _a;
            return mapNullable((_a = this._parameters) === null || _a === void 0 ? void 0 : _a.resetsAt, function (v) { return new Date(v); });
        },
        enumerable: false,
        configurable: true
    });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        promises = reqSpecs.map(function (reqSpec) { return __awaiter(_this, void 0, Promise, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 3:
                                        e_1 = _a.sent();
                                        if (e_1 instanceof RetryAfterError) {
                                            throw e_1;
                                        }
                                        reject(e_1);
                    ...
                    case 1:
                        ...
                        if (rejectedPromises.length) {
                            ...
                            retryAt = Math.max.apply(Math, __spread([now], rejectedPromises.map(function (p) { return p.reason.retryAt; })));
...
export { ResponseBasedRateLimiter };
