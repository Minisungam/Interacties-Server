...
var BaseLogger = /** @class */ (function () {
    function BaseLogger(_a) {
        ...
        var _d, _e;
        this._name = name;
        this._minLevel = (_e = (_d = mapOptional(minLevel, function (lv) { return resolveLogLevel(lv); })) !== null && _d !== void 0 ? _d : getMinLogLevelFromEnv(name)) !== null && _e !== void 0 ? _e : LogLevel.WARNING;
        this._emoji = emoji;
        this._colors = colors;
