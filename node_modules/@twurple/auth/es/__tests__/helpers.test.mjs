import { compareScopes } from "../helpers.mjs";
describe('Scope comparer', () => {
    ...
    it('passes when required scopes are met', () => {
        ...
        compareScopes(['bits:read', 'channel:moderate', 'channel:read:goals'], ['bits:read', 'channel:moderate', 'channel:read:goals']);
    });
    ...
    it('passes for scope equivalencies', () => {
        ...
        compareScopes(['channel_subscriptions', 'channel:read:subscriptions'], ['channel_subscriptions', 'channel:read:subscriptions']);
        compareScopes(['channel_subscriptions', 'user_blocks_read'], ['channel:read:subscriptions']);
        compareScopes(['channel_subscriptions', 'user_blocks_read'], ['channel:read:subscriptions', 'user:read:blocked_users']);
        compareScopes(['channel_subscriptions', 'user_blocks_read', 'channel:read:goals'], ['channel:read:subscriptions', 'user:read:blocked_users']);
        compareScopes(['channel_subscriptions', 'user_blocks_read', 'channel:read:goals'], ['channel:read:subscriptions', 'user:read:blocked_users', 'channel:read:goals']);
    });
