...
let HelixEventSubApi = class HelixEventSubApi extends BaseApi_1.BaseApi {
    ...
    async getSubscriptions(pagination) {
        const result = await this._client.callApi({
            ...
            query: (0, HelixPagination_1.makePaginationQuery)(pagination)
        });
        return (0, HelixPaginatedResult_1.createPaginatedResultWithTotal)(result, HelixEventSubSubscription_1.HelixEventSubSubscription, this._client);
    }
    /**
    ...
    async subscribeToStreamOnlineEvents(broadcaster, transport) {
        return await this.createSubscription('stream.online', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToStreamOfflineEvents(broadcaster, transport) {
        return await this.createSubscription('stream.offline', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelUpdateEvents(broadcaster, transport) {
        return await this.createSubscription('channel.update', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelFollowEvents(broadcaster, transport) {
        return await this.createSubscription('channel.follow', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelSubscriptionEvents(broadcaster, transport) {
        return await this.createSubscription('channel.subscribe', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelSubscriptionGiftEvents(broadcaster, transport) {
        return await this.createSubscription('channel.subscription.gift', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelSubscriptionMessageEvents(broadcaster, transport) {
        return await this.createSubscription('channel.subscription.message', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelSubscriptionEndEvents(broadcaster, transport) {
        return await this.createSubscription('channel.subscription.end', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelCheerEvents(broadcaster, transport) {
        return await this.createSubscription('channel.cheer', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelBanEvents(broadcaster, transport) {
        return await this.createSubscription('channel.ban', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelUnbanEvents(broadcaster, transport) {
        return await this.createSubscription('channel.unban', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelModeratorAddEvents(broadcaster, transport) {
        return await this.createSubscription('channel.moderator.add', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelModeratorRemoveEvents(broadcaster, transport) {
        return await this.createSubscription('channel.moderator.remove', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelRaidEventsFrom(broadcaster, transport) {
        return await this.createSubscription('channel.raid', '1', { from_broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelRaidEventsTo(broadcaster, transport) {
        return await this.createSubscription('channel.raid', '1', { to_broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelRewardAddEvents(broadcaster, transport) {
        return await this.createSubscription('channel.channel_points_custom_reward.add', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelRewardUpdateEvents(broadcaster, transport) {
        return await this.createSubscription('channel.channel_points_custom_reward.update', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelRewardUpdateEventsForReward(broadcaster, rewardId, transport) {
        return await this.createSubscription('channel.channel_points_custom_reward.update', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster), reward_id: rewardId }, transport);
    }
    /**
    ...
    async subscribeToChannelRewardRemoveEvents(broadcaster, transport) {
        return await this.createSubscription('channel.channel_points_custom_reward.remove', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelRewardRemoveEventsForReward(broadcaster, rewardId, transport) {
        return await this.createSubscription('channel.channel_points_custom_reward.remove', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster), reward_id: rewardId }, transport);
    }
    /**
    ...
    async subscribeToChannelRedemptionAddEvents(broadcaster, transport) {
        return await this.createSubscription('channel.channel_points_custom_reward_redemption.add', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelRedemptionAddEventsForReward(broadcaster, rewardId, transport) {
        return await this.createSubscription('channel.channel_points_custom_reward_redemption.add', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster), reward_id: rewardId }, transport);
    }
    /**
    ...
    async subscribeToChannelRedemptionUpdateEvents(broadcaster, transport) {
        return await this.createSubscription('channel.channel_points_custom_reward_redemption.update', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelRedemptionUpdateEventsForReward(broadcaster, rewardId, transport) {
        return await this.createSubscription('channel.channel_points_custom_reward_redemption.update', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster), reward_id: rewardId }, transport);
    }
    /**
    ...
    async subscribeToChannelPollBeginEvents(broadcaster, transport) {
        return await this.createSubscription('channel.poll.begin', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPollProgressEvents(broadcaster, transport) {
        return await this.createSubscription('channel.poll.progress', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPollEndEvents(broadcaster, transport) {
        return await this.createSubscription('channel.poll.end', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPredictionBeginEvents(broadcaster, transport) {
        return await this.createSubscription('channel.prediction.begin', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPredictionProgressEvents(broadcaster, transport) {
        return await this.createSubscription('channel.prediction.progress', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPredictionLockEvents(broadcaster, transport) {
        return await this.createSubscription('channel.prediction.lock', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelPredictionEndEvents(broadcaster, transport) {
        return await this.createSubscription('channel.prediction.end', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelGoalBeginEvents(broadcaster, transport) {
        return await this.createSubscription('channel.goal.begin', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelGoalProgressEvents(broadcaster, transport) {
        return await this.createSubscription('channel.goal.progress', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelGoalEndEvents(broadcaster, transport) {
        return await this.createSubscription('channel.goal.end', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelHypeTrainBeginEvents(broadcaster, transport) {
        return await this.createSubscription('channel.hype_train.begin', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelHypeTrainProgressEvents(broadcaster, transport) {
        return await this.createSubscription('channel.hype_train.progress', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelHypeTrainEndEvents(broadcaster, transport) {
        return await this.createSubscription('channel.hype_train.end', '1', { broadcaster_user_id: (0, common_1.extractUserId)(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToUserUpdateEvents(user, transport) {
        return await this.createSubscription('user.update', '1', { user_id: (0, common_1.extractUserId)(user) }, transport);
    }
