...
let HelixEventSubApi = class HelixEventSubApi extends BaseApi {
    ...
    async subscribeToChannelGoalBeginEvents(broadcaster, transport) {
        return await this.createSubscription('channel.goal.begin', '1', { broadcaster_user_id: extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelGoalProgressEvents(broadcaster, transport) {
        return await this.createSubscription('channel.goal.progress', '1', { broadcaster_user_id: extractUserId(broadcaster) }, transport);
    }
    /**
    ...
    async subscribeToChannelGoalEndEvents(broadcaster, transport) {
        return await this.createSubscription('channel.goal.end', '1', { broadcaster_user_id: extractUserId(broadcaster) }, transport);
    }
    /**
